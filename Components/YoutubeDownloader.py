...
def download_youtube_video(url):
    try:
        ...
        safe_title = sanitize_filename(yt.title)  # Sanitize the title
        ...
        if not selected_stream.is_progressive:
            ...
            output_file = os.path.join('videos', f"{safe_title}.mp4")  # Use sanitized title
            ...
            # For progressive streams, the downloaded file already has audio.
            # Just rename it properly.
